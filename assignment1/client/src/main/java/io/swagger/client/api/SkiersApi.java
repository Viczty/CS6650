...
public class SkiersApi {
     ...
     */
    public String getSkierDayVertical(Integer resortID, String seasonID, String dayID, Integer skierID) throws ApiException {
        ApiResponse<String> resp = getSkierDayVerticalWithHttpInfo(resortID, seasonID, dayID, skierID);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<String> getSkierDayVerticalWithHttpInfo(Integer resortID, String seasonID, String dayID, Integer skierID) throws ApiException {
