...
public class Client2 {
  ...
  public Client2(int numThreads, int numSkiers, int numLifts, int numRuns, String IP) {
  ...
  public static void main(String[] args) throws InterruptedException {
    ...
    final Client2 client = new Client2(32, 20000, 40, 20, "http://54.211.60.243:8080/server_war");
